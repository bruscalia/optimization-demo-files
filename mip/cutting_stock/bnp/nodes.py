...
class BaseNode:
    ...
    def __init__(self, branching_rule: str = "min", pricing_rule: Callable = None):
...
class Node(BaseNode):
    ...
    def __init__(self, parent: BaseNode, i: int, xi_lb: int, xi_ub: int, branching_rule="frac") -> None:
        super().__init__(branching_rule=branching_rule, pricing_rule=parent.pricing_rule)
        self.parent = parent
        self.c = parent.c
        ...
        self.i = i
        self.lb = parent.lb.copy()
        self.lb[self.i] = xi_lb
        self.ub = parent.ub.copy()
        self.ub[self.i] = xi_ub
...
class RootNode(BaseNode):
    ...
    def __init__(self, c, pricing_rule: Callable, A_ub=None, b_ub=None, A_eq=None, b_eq=None, lb=0, ub=np.inf,
                 integrality=None, int_tol=1e-6, branching_rule="frac"):
        super().__init__(branching_rule=branching_rule, pricing_rule=pricing_rule)
